...
package com.zcc.multimedia.grafika;
...
import com.zcc.multimedia.record.MuxerHolder;
...
public class VideoEncoderCore {
     ...
     */
    public VideoEncoderCore(int width, int height, int bitRate, String outputFile, MuxerHolder muxerHolder)
            throws IOException {
        mBufferInfo = new MediaCodec.BufferInfo();
        this.mMuxerHolder = muxerHolder;
